...
void protobuf_AddDesc_ql2_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\tql2.proto\022\rcom.rethinkdb\"5\n\014VersionDum"
    "my\"%\n\007Version\022\014\n\004V0_1\020\266\364\206\373\003\022\014\n\004V0_2\020\341\203\302\221"
    "\007\"\255\002\n\005Query\022,\n\004type\030\001 \001(\0162\036.com.rethinkd"
    "b.Query.QueryType\022\"\n\005query\030\002 \001(\0132\023.com.r"
    "ethinkdb.Term\022\r\n\005token\030\003 \001(\003\022\037\n\020OBSOLETE"
    "_noreply\030\004 \001(\010:\005false\0226\n\016global_optargs\030"
    "\006 \003(\0132\036.com.rethinkdb.Query.AssocPair\032:\n"
    "\tAssocPair\022\013\n\003key\030\001 \001(\t\022 \n\003val\030\002 \001(\0132\023.c"
    "om.rethinkdb.Term\".\n\tQueryType\022\t\n\005START\020"
    "\001\022\014\n\010CONTINUE\020\002\022\010\n\004STOP\020\003\"n\n\005Frame\022,\n\004ty"
    "pe\030\001 \001(\0162\036.com.rethinkdb.Frame.FrameType"
    "\022\013\n\003pos\030\002 \001(\003\022\013\n\003opt\030\003 \001(\t\"\035\n\tFrameType\022"
    "\007\n\003POS\020\001\022\007\n\003OPT\020\002\"1\n\tBacktrace\022$\n\006frames"
    "\030\001 \003(\0132\024.com.rethinkdb.Frame\"\250\002\n\010Respons"
    "e\0222\n\004type\030\001 \001(\0162$.com.rethinkdb.Response"
    ".ResponseType\022\r\n\005token\030\002 \001(\003\022&\n\010response"
    "\030\003 \003(\0132\024.com.rethinkdb.Datum\022+\n\tbacktrac"
    "e\030\004 \001(\0132\030.com.rethinkdb.Backtrace\"\203\001\n\014Re"
    "sponseType\022\020\n\014SUCCESS_ATOM\020\001\022\024\n\020SUCCESS_"
    "SEQUENCE\020\002\022\023\n\017SUCCESS_PARTIAL\020\003\022\020\n\014CLIEN"
    "T_ERROR\020\020\022\021\n\rCOMPILE_ERROR\020\021\022\021\n\rRUNTIME_"
    "ERROR\020\022\"\330\002\n\005Datum\022,\n\004type\030\001 \001(\0162\036.com.re"
    "thinkdb.Datum.DatumType\022\016\n\006r_bool\030\002 \001(\010\022"
    "\r\n\005r_num\030\003 \001(\001\022\r\n\005r_str\030\004 \001(\t\022%\n\007r_array"
    "\030\005 \003(\0132\024.com.rethinkdb.Datum\0220\n\010r_object"
    "\030\006 \003(\0132\036.com.rethinkdb.Datum.AssocPair\032;"
    "\n\tAssocPair\022\013\n\003key\030\001 \001(\t\022!\n\003val\030\002 \001(\0132\024."
    "com.rethinkdb.Datum\"T\n\tDatumType\022\n\n\006R_NU"
    "LL\020\001\022\n\n\006R_BOOL\020\002\022\t\n\005R_NUM\020\003\022\t\n\005R_STR\020\004\022\013"
    "\n\007R_ARRAY\020\005\022\014\n\010R_OBJECT\020\006*\007\010\220N\020\241\234\001\"\374\016\n\004T"
    "erm\022*\n\004type\030\001 \001(\0162\034.com.rethinkdb.Term.T"
    "ermType\022#\n\005datum\030\002 \001(\0132\024.com.rethinkdb.D"
    "atum\022!\n\004args\030\003 \003(\0132\023.com.rethinkdb.Term\022"
    ".\n\007optargs\030\004 \003(\0132\035.com.rethinkdb.Term.As"
    "socPair\032:\n\tAssocPair\022\013\n\003key\030\001 \001(\t\022 \n\003val"
    "\030\002 \001(\0132\023.com.rethinkdb.Term\"\212\r\n\010TermType"
    ...
    "DECEMBER\020}\022\014\n\007LITERAL\020\211\001*\007\010\220N\020\241\234\001", 3113);
...
const VersionDummy& VersionDummy::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_ql2_2eproto();
...
void Query_AssocPair::InitAsDefaultInstance() {
  val_ = const_cast< ::com::rethinkdb::Term*>(&::com::rethinkdb::Term::default_instance());
}
...
void Query_AssocPair::MergeFrom(const Query_AssocPair& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_val()) {
      mutable_val()->::com::rethinkdb::Term::MergeFrom(from.val());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void Query::InitAsDefaultInstance() {
  query_ = const_cast< ::com::rethinkdb::Term*>(&::com::rethinkdb::Term::default_instance());
}
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::com::rethinkdb::Query_QueryType_IsValid(value)) {
            set_type(static_cast< ::com::rethinkdb::Query_QueryType >(value));
          } else {
...
void Query::MergeFrom(const Query& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_query()) {
      mutable_query()->::com::rethinkdb::Term::MergeFrom(from.query());
    }
    if (from.has_token()) {
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::com::rethinkdb::Frame_FrameType_IsValid(value)) {
            set_type(static_cast< ::com::rethinkdb::Frame_FrameType >(value));
          } else {
            mutable_unknown_fields()->AddVarint(1, value);
          }
        } else {
...
void Response::InitAsDefaultInstance() {
  backtrace_ = const_cast< ::com::rethinkdb::Backtrace*>(&::com::rethinkdb::Backtrace::default_instance());
}
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::com::rethinkdb::Response_ResponseType_IsValid(value)) {
            set_type(static_cast< ::com::rethinkdb::Response_ResponseType >(value));
          } else {
            mutable_unknown_fields()->AddVarint(1, value);
          }
        } else {
...
void Response::MergeFrom(const Response& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_backtrace()) {
      mutable_backtrace()->::com::rethinkdb::Backtrace::MergeFrom(from.backtrace());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void Datum_AssocPair::InitAsDefaultInstance() {
  val_ = const_cast< ::com::rethinkdb::Datum*>(&::com::rethinkdb::Datum::default_instance());
}
...
void Datum_AssocPair::MergeFrom(const Datum_AssocPair& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_val()) {
      mutable_val()->::com::rethinkdb::Datum::MergeFrom(from.val());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::com::rethinkdb::Datum_DatumType_IsValid(value)) {
            set_type(static_cast< ::com::rethinkdb::Datum_DatumType >(value));
          } else {
            mutable_unknown_fields()->AddVarint(1, value);
          }
        } else {
...
void Term::InitAsDefaultInstance() {
  datum_ = const_cast< ::com::rethinkdb::Datum*>(&::com::rethinkdb::Datum::default_instance());
}
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::com::rethinkdb::Term_TermType_IsValid(value)) {
            set_type(static_cast< ::com::rethinkdb::Term_TermType >(value));
          } else {
            mutable_unknown_fields()->AddVarint(1, value);
          }
        } else {
...
void Term::MergeFrom(const Term& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_datum()) {
      mutable_datum()->::com::rethinkdb::Datum::MergeFrom(from.datum());
    }
  }
  _extensions_.MergeFrom(from._extensions_);
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
