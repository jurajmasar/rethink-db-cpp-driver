...
class VersionDummy : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:com.rethinkdb.VersionDummy)
 private:
...
class Query_AssocPair : public ::google::protobuf::Message {
 public:
  ...
  // optional .com.rethinkdb.Term val = 2;
  inline bool has_val() const;
  inline void clear_val();
  static const int kValFieldNumber = 2;
  inline const ::com::rethinkdb::Term& val() const;
  inline ::com::rethinkdb::Term* mutable_val();
  inline ::com::rethinkdb::Term* release_val();
  inline void set_allocated_val(::com::rethinkdb::Term* val);

  // @@protoc_insertion_point(class_scope:com.rethinkdb.Query.AssocPair)
 private:
...
class Query : public ::google::protobuf::Message {
 public:
  ...
  // optional .com.rethinkdb.Query.QueryType type = 1;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::com::rethinkdb::Query_QueryType type() const;
  inline void set_type(::com::rethinkdb::Query_QueryType value);

  // optional .com.rethinkdb.Term query = 2;
  inline bool has_query() const;
  inline void clear_query();
  static const int kQueryFieldNumber = 2;
  inline const ::com::rethinkdb::Term& query() const;
  inline ::com::rethinkdb::Term* mutable_query();
  inline ::com::rethinkdb::Term* release_query();
  inline void set_allocated_query(::com::rethinkdb::Term* query);
  ...
  // repeated .com.rethinkdb.Query.AssocPair global_optargs = 6;
  inline int global_optargs_size() const;
  inline void clear_global_optargs();
  static const int kGlobalOptargsFieldNumber = 6;
  inline const ::com::rethinkdb::Query_AssocPair& global_optargs(int index) const;
  inline ::com::rethinkdb::Query_AssocPair* mutable_global_optargs(int index);
  inline ::com::rethinkdb::Query_AssocPair* add_global_optargs();
  inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Query_AssocPair >&
      global_optargs() const;
  inline ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Query_AssocPair >*
      mutable_global_optargs();

  // @@protoc_insertion_point(class_scope:com.rethinkdb.Query)
 private:
  ...
  ::com::rethinkdb::Term* query_;
  int type_;
  bool obsolete_noreply_;
  ::google::protobuf::int64 token_;
  ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Query_AssocPair > global_optargs_;
...
class Frame : public ::google::protobuf::Message {
 public:
  ...
  // optional .com.rethinkdb.Frame.FrameType type = 1;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::com::rethinkdb::Frame_FrameType type() const;
  inline void set_type(::com::rethinkdb::Frame_FrameType value);
  ...
  // @@protoc_insertion_point(class_scope:com.rethinkdb.Frame)
 private:
  inline void set_has_type();
  inline void clear_has_type();
...
class Backtrace : public ::google::protobuf::Message {
 public:
  ...
  // repeated .com.rethinkdb.Frame frames = 1;
  inline int frames_size() const;
  inline void clear_frames();
  static const int kFramesFieldNumber = 1;
  inline const ::com::rethinkdb::Frame& frames(int index) const;
  inline ::com::rethinkdb::Frame* mutable_frames(int index);
  inline ::com::rethinkdb::Frame* add_frames();
  inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Frame >&
      frames() const;
  inline ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Frame >*
      mutable_frames();

  // @@protoc_insertion_point(class_scope:com.rethinkdb.Backtrace)
 private:

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Frame > frames_;
...
class Response : public ::google::protobuf::Message {
 public:
  ...
  // optional .com.rethinkdb.Response.ResponseType type = 1;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::com::rethinkdb::Response_ResponseType type() const;
  inline void set_type(::com::rethinkdb::Response_ResponseType value);
  ...
  // repeated .com.rethinkdb.Datum response = 3;
  inline int response_size() const;
  inline void clear_response();
  static const int kResponseFieldNumber = 3;
  inline const ::com::rethinkdb::Datum& response(int index) const;
  inline ::com::rethinkdb::Datum* mutable_response(int index);
  inline ::com::rethinkdb::Datum* add_response();
  inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum >&
      response() const;
  inline ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum >*
      mutable_response();

  // optional .com.rethinkdb.Backtrace backtrace = 4;
  inline bool has_backtrace() const;
  inline void clear_backtrace();
  static const int kBacktraceFieldNumber = 4;
  inline const ::com::rethinkdb::Backtrace& backtrace() const;
  inline ::com::rethinkdb::Backtrace* mutable_backtrace();
  inline ::com::rethinkdb::Backtrace* release_backtrace();
  inline void set_allocated_backtrace(::com::rethinkdb::Backtrace* backtrace);

  // @@protoc_insertion_point(class_scope:com.rethinkdb.Response)
 private:
  inline void set_has_type();
  inline void clear_has_type();
  inline void set_has_token();
  ...
  ::google::protobuf::int64 token_;
  ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum > response_;
  ::com::rethinkdb::Backtrace* backtrace_;
  int type_;
...
class Datum_AssocPair : public ::google::protobuf::Message {
 public:
  ...
  // optional .com.rethinkdb.Datum val = 2;
  inline bool has_val() const;
  inline void clear_val();
  static const int kValFieldNumber = 2;
  inline const ::com::rethinkdb::Datum& val() const;
  inline ::com::rethinkdb::Datum* mutable_val();
  inline ::com::rethinkdb::Datum* release_val();
  inline void set_allocated_val(::com::rethinkdb::Datum* val);

  // @@protoc_insertion_point(class_scope:com.rethinkdb.Datum.AssocPair)
 private:
  inline void set_has_key();
  inline void clear_has_key();
  inline void set_has_val();
...
class Datum : public ::google::protobuf::Message {
 public:
  ...
  // optional .com.rethinkdb.Datum.DatumType type = 1;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::com::rethinkdb::Datum_DatumType type() const;
  inline void set_type(::com::rethinkdb::Datum_DatumType value);
  ...
  // repeated .com.rethinkdb.Datum r_array = 5;
  inline int r_array_size() const;
  inline void clear_r_array();
  static const int kRArrayFieldNumber = 5;
  inline const ::com::rethinkdb::Datum& r_array(int index) const;
  inline ::com::rethinkdb::Datum* mutable_r_array(int index);
  inline ::com::rethinkdb::Datum* add_r_array();
  inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum >&
      r_array() const;
  inline ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum >*
      mutable_r_array();

  // repeated .com.rethinkdb.Datum.AssocPair r_object = 6;
  inline int r_object_size() const;
  inline void clear_r_object();
  static const int kRObjectFieldNumber = 6;
  inline const ::com::rethinkdb::Datum_AssocPair& r_object(int index) const;
  inline ::com::rethinkdb::Datum_AssocPair* mutable_r_object(int index);
  inline ::com::rethinkdb::Datum_AssocPair* add_r_object();
  inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum_AssocPair >&
      r_object() const;
  inline ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum_AssocPair >*
      mutable_r_object();

  GOOGLE_PROTOBUF_EXTENSION_ACCESSORS(Datum)
  // @@protoc_insertion_point(class_scope:com.rethinkdb.Datum)
 private:
  inline void set_has_type();
  inline void clear_has_type();
  ...
  double r_num_;
  ::std::string* r_str_;
  ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum > r_array_;
  ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum_AssocPair > r_object_;
...
class Term_AssocPair : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:com.rethinkdb.Term.AssocPair)
 private:
  inline void set_has_key();
  inline void clear_has_key();
  inline void set_has_val();
...
class Term : public ::google::protobuf::Message {
 public:
  ...
  // optional .com.rethinkdb.Term.TermType type = 1;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::com::rethinkdb::Term_TermType type() const;
  inline void set_type(::com::rethinkdb::Term_TermType value);

  // optional .com.rethinkdb.Datum datum = 2;
  inline bool has_datum() const;
  inline void clear_datum();
  static const int kDatumFieldNumber = 2;
  inline const ::com::rethinkdb::Datum& datum() const;
  inline ::com::rethinkdb::Datum* mutable_datum();
  inline ::com::rethinkdb::Datum* release_datum();
  inline void set_allocated_datum(::com::rethinkdb::Datum* datum);

  // repeated .com.rethinkdb.Term args = 3;
  inline int args_size() const;
  inline void clear_args();
  static const int kArgsFieldNumber = 3;
  inline const ::com::rethinkdb::Term& args(int index) const;
  inline ::com::rethinkdb::Term* mutable_args(int index);
  inline ::com::rethinkdb::Term* add_args();
  inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Term >&
      args() const;
  inline ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Term >*
      mutable_args();

  // repeated .com.rethinkdb.Term.AssocPair optargs = 4;
  inline int optargs_size() const;
  inline void clear_optargs();
  static const int kOptargsFieldNumber = 4;
  inline const ::com::rethinkdb::Term_AssocPair& optargs(int index) const;
  inline ::com::rethinkdb::Term_AssocPair* mutable_optargs(int index);
  inline ::com::rethinkdb::Term_AssocPair* add_optargs();
  inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Term_AssocPair >&
      optargs() const;
  inline ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Term_AssocPair >*
      mutable_optargs();

  GOOGLE_PROTOBUF_EXTENSION_ACCESSORS(Term)
  // @@protoc_insertion_point(class_scope:com.rethinkdb.Term)
 private:
  inline void set_has_type();
  inline void clear_has_type();
  ...
  ::com::rethinkdb::Datum* datum_;
  ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Term > args_;
  ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Term_AssocPair > optargs_;
  int type_;
...
inline void Query_AssocPair::clear_val() {
  if (val_ != NULL) val_->::com::rethinkdb::Term::Clear();
  clear_has_val();
}
inline const ::com::rethinkdb::Term& Query_AssocPair::val() const {
  return val_ != NULL ? *val_ : *default_instance_->val_;
}
inline ::com::rethinkdb::Term* Query_AssocPair::mutable_val() {
  set_has_val();
  if (val_ == NULL) val_ = new ::com::rethinkdb::Term;
  return val_;
}
inline ::com::rethinkdb::Term* Query_AssocPair::release_val() {
  clear_has_val();
  ::com::rethinkdb::Term* temp = val_;
  val_ = NULL;
  return temp;
}
inline void Query_AssocPair::set_allocated_val(::com::rethinkdb::Term* val) {
  delete val_;
  val_ = val;
  if (val) {
    set_has_val();
...
inline ::com::rethinkdb::Query_QueryType Query::type() const {
  return static_cast< ::com::rethinkdb::Query_QueryType >(type_);
}
inline void Query::set_type(::com::rethinkdb::Query_QueryType value) {
  assert(::com::rethinkdb::Query_QueryType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void Query::clear_query() {
  if (query_ != NULL) query_->::com::rethinkdb::Term::Clear();
  clear_has_query();
}
inline const ::com::rethinkdb::Term& Query::query() const {
  return query_ != NULL ? *query_ : *default_instance_->query_;
}
inline ::com::rethinkdb::Term* Query::mutable_query() {
  set_has_query();
  if (query_ == NULL) query_ = new ::com::rethinkdb::Term;
  return query_;
}
inline ::com::rethinkdb::Term* Query::release_query() {
  clear_has_query();
  ::com::rethinkdb::Term* temp = query_;
  query_ = NULL;
  return temp;
}
inline void Query::set_allocated_query(::com::rethinkdb::Term* query) {
  delete query_;
  query_ = query;
  if (query) {
    set_has_query();
...
inline const ::com::rethinkdb::Query_AssocPair& Query::global_optargs(int index) const {
  return global_optargs_.Get(index);
}
inline ::com::rethinkdb::Query_AssocPair* Query::mutable_global_optargs(int index) {
  return global_optargs_.Mutable(index);
}
inline ::com::rethinkdb::Query_AssocPair* Query::add_global_optargs() {
...
inline ::com::rethinkdb::Frame_FrameType Frame::type() const {
  return static_cast< ::com::rethinkdb::Frame_FrameType >(type_);
}
inline void Frame::set_type(::com::rethinkdb::Frame_FrameType value) {
  assert(::com::rethinkdb::Frame_FrameType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline const ::com::rethinkdb::Frame& Backtrace::frames(int index) const {
  return frames_.Get(index);
}
inline ::com::rethinkdb::Frame* Backtrace::mutable_frames(int index) {
  return frames_.Mutable(index);
}
inline ::com::rethinkdb::Frame* Backtrace::add_frames() {
  return frames_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Frame >&
...
inline ::com::rethinkdb::Response_ResponseType Response::type() const {
  return static_cast< ::com::rethinkdb::Response_ResponseType >(type_);
}
inline void Response::set_type(::com::rethinkdb::Response_ResponseType value) {
  assert(::com::rethinkdb::Response_ResponseType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline const ::com::rethinkdb::Datum& Response::response(int index) const {
  return response_.Get(index);
}
inline ::com::rethinkdb::Datum* Response::mutable_response(int index) {
  return response_.Mutable(index);
}
inline ::com::rethinkdb::Datum* Response::add_response() {
...
inline void Response::clear_backtrace() {
  if (backtrace_ != NULL) backtrace_->::com::rethinkdb::Backtrace::Clear();
  clear_has_backtrace();
}
inline const ::com::rethinkdb::Backtrace& Response::backtrace() const {
  return backtrace_ != NULL ? *backtrace_ : *default_instance_->backtrace_;
}
inline ::com::rethinkdb::Backtrace* Response::mutable_backtrace() {
  set_has_backtrace();
  if (backtrace_ == NULL) backtrace_ = new ::com::rethinkdb::Backtrace;
  return backtrace_;
}
inline ::com::rethinkdb::Backtrace* Response::release_backtrace() {
  clear_has_backtrace();
  ::com::rethinkdb::Backtrace* temp = backtrace_;
  backtrace_ = NULL;
  return temp;
}
inline void Response::set_allocated_backtrace(::com::rethinkdb::Backtrace* backtrace) {
  delete backtrace_;
...
inline void Datum_AssocPair::clear_val() {
  if (val_ != NULL) val_->::com::rethinkdb::Datum::Clear();
  clear_has_val();
}
inline const ::com::rethinkdb::Datum& Datum_AssocPair::val() const {
  return val_ != NULL ? *val_ : *default_instance_->val_;
}
inline ::com::rethinkdb::Datum* Datum_AssocPair::mutable_val() {
  set_has_val();
  if (val_ == NULL) val_ = new ::com::rethinkdb::Datum;
  return val_;
}
inline ::com::rethinkdb::Datum* Datum_AssocPair::release_val() {
  clear_has_val();
  ::com::rethinkdb::Datum* temp = val_;
  val_ = NULL;
  return temp;
}
inline void Datum_AssocPair::set_allocated_val(::com::rethinkdb::Datum* val) {
  delete val_;
  val_ = val;
  if (val) {
    set_has_val();
...
inline ::com::rethinkdb::Datum_DatumType Datum::type() const {
  return static_cast< ::com::rethinkdb::Datum_DatumType >(type_);
}
inline void Datum::set_type(::com::rethinkdb::Datum_DatumType value) {
  assert(::com::rethinkdb::Datum_DatumType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline const ::com::rethinkdb::Datum& Datum::r_array(int index) const {
  return r_array_.Get(index);
}
inline ::com::rethinkdb::Datum* Datum::mutable_r_array(int index) {
  return r_array_.Mutable(index);
}
inline ::com::rethinkdb::Datum* Datum::add_r_array() {
  return r_array_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Datum >&
Datum::r_array() const {
...
inline const ::com::rethinkdb::Datum_AssocPair& Datum::r_object(int index) const {
  return r_object_.Get(index);
}
inline ::com::rethinkdb::Datum_AssocPair* Datum::mutable_r_object(int index) {
  return r_object_.Mutable(index);
}
inline ::com::rethinkdb::Datum_AssocPair* Datum::add_r_object() {
...
inline const ::com::rethinkdb::Term& Term_AssocPair::val() const {
  return val_ != NULL ? *val_ : *default_instance_->val_;
}
inline ::com::rethinkdb::Term* Term_AssocPair::mutable_val() {
  set_has_val();
  if (val_ == NULL) val_ = new ::com::rethinkdb::Term;
  return val_;
}
inline ::com::rethinkdb::Term* Term_AssocPair::release_val() {
  clear_has_val();
  ::com::rethinkdb::Term* temp = val_;
  val_ = NULL;
  return temp;
}
inline void Term_AssocPair::set_allocated_val(::com::rethinkdb::Term* val) {
  delete val_;
  val_ = val;
  if (val) {
    set_has_val();
...
inline ::com::rethinkdb::Term_TermType Term::type() const {
  return static_cast< ::com::rethinkdb::Term_TermType >(type_);
}
inline void Term::set_type(::com::rethinkdb::Term_TermType value) {
  assert(::com::rethinkdb::Term_TermType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void Term::clear_datum() {
  if (datum_ != NULL) datum_->::com::rethinkdb::Datum::Clear();
  clear_has_datum();
}
inline const ::com::rethinkdb::Datum& Term::datum() const {
  return datum_ != NULL ? *datum_ : *default_instance_->datum_;
}
inline ::com::rethinkdb::Datum* Term::mutable_datum() {
  set_has_datum();
  if (datum_ == NULL) datum_ = new ::com::rethinkdb::Datum;
  return datum_;
}
inline ::com::rethinkdb::Datum* Term::release_datum() {
  clear_has_datum();
  ::com::rethinkdb::Datum* temp = datum_;
  datum_ = NULL;
  return temp;
}
inline void Term::set_allocated_datum(::com::rethinkdb::Datum* datum) {
  delete datum_;
  datum_ = datum;
  if (datum) {
    set_has_datum();
...
inline const ::com::rethinkdb::Term& Term::args(int index) const {
  return args_.Get(index);
}
inline ::com::rethinkdb::Term* Term::mutable_args(int index) {
  return args_.Mutable(index);
}
inline ::com::rethinkdb::Term* Term::add_args() {
  return args_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Term >&
Term::args() const {
...
inline const ::com::rethinkdb::Term_AssocPair& Term::optargs(int index) const {
  return optargs_.Get(index);
}
inline ::com::rethinkdb::Term_AssocPair* Term::mutable_optargs(int index) {
  return optargs_.Mutable(index);
}
inline ::com::rethinkdb::Term_AssocPair* Term::add_optargs() {
  return optargs_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::rethinkdb::Term_AssocPair >&
Term::optargs() const {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::rethinkdb::VersionDummy_Version>() {
  return ::com::rethinkdb::VersionDummy_Version_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::rethinkdb::Query_QueryType>() {
  return ::com::rethinkdb::Query_QueryType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::rethinkdb::Frame_FrameType>() {
  return ::com::rethinkdb::Frame_FrameType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::rethinkdb::Response_ResponseType>() {
  return ::com::rethinkdb::Response_ResponseType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::rethinkdb::Datum_DatumType>() {
  return ::com::rethinkdb::Datum_DatumType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::rethinkdb::Term_TermType>() {
  return ::com::rethinkdb::Term_TermType_descriptor();
}
